...
| **B. Money in** | One cleared payment → one 85% credit | Invoices/webhooks set up so **duplicates don’t double-credit**; store gross/fee/net; never bump balance from the client alone |
