...
export default function ClipperCampaignDetailPage() {
  ...
  return (
    <div className="space-y-8 rounded-2xl bg-muted/35 px-4 py-6 sm:px-5 sm:py-8 md:-mx-2 md:px-6">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 flex-1 space-y-3">
            ...
            <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-stretch sm:gap-4">
              <div className="rounded-2xl border-2 border-blue-200/90 bg-linear-to-br from-blue-50/95 to-sky-50/80 px-5 py-4 shadow-sm dark:border-blue-800/60 dark:from-blue-950/50 dark:to-sky-950/40">
              ...
              <div className="flex items-center gap-1.5 text-sm text-muted-foreground sm:min-w-0 sm:flex-1 sm:self-center">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">Where your content can be posted.</p>
                </div>
              </div>
          ...
          <div>
            ...
            {campaign.sampleUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-3 flex items-center justify-between rounded-2xl border border-border bg-muted/30 px-4 py-3 transition-colors hover:bg-muted"
              >
      ...
      <div className="flex items-center justify-center gap-2 rounded-xl border border-border bg-muted/40 px-4 py-3 text-center text-xs text-muted-foreground sm:text-sm">
